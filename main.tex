...
\begin{document}
    ...
    \input{chapters/certificateoforiginality}
    ...
    \input{chapters/1_introduction/1_root}
    \input{chapters/2_literature_review/2_root}
    \input{chapters/3_methodology/3_root}
    \input{chapters/4_results_and_discussion/4_root}
    \input{chapters/5_conclusion_and_future_work/5_root}
